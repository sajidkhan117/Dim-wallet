...
import CustomizedSwitches from "./On"
            ...
            <div className="lower-main">
              <div className="upper-content">
                <div className="upper-img-content">
                  ...
                  <p>
                    <a href="/">xxxx@gmail.com</a> Just reffered <br />
                    <a className="" href="/">
                      xxxx@yahoo.com
                    </a>
                  </p>
          ...
          <div className="lower">
            ...
            <div className="lower-down-content">
              ...
              {/* <div>
                ...
                <button className="btn_on">ON</button>
                <button className="btn_off">Off</button>
              </div> */}
            </div>
          </div>
        </div>
